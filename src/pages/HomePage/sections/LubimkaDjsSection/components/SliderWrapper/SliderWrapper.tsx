...
export default function SliderWrapper({ className, children }: ISliderWrapperProps) {
  const { settings, length, curSlide, sliderRef } = useSliderData(); //Прячем настройки и прочую штуку сюда
